...
Message: ${message}
    ...
    const whatsappUrl = `https://wa.me/96171081432?text=${encodeURIComponent(text)}`;
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-4 mt-3">
                  ...
                  <a
                    href="https://github.com/MohamadAl-Zohbi"
                    className="
                    px-4 py-2
                  ...
                  <a
                    href="https://www.linkedin.com/in/mohamad-al-zohbi/"
                    className="
                    px-4 py-2
                    border border-blue-500
                    rounded-lg
